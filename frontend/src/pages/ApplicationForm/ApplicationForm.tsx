        ...
        <div>
            ...
            <Card version="orange-card">
                <Wrapper wrapperType="block" className={styles.applicationForm}>
                    <Text size="text-h1" weight="font-bold" layout="text-block" align="text-center">Запись на
                        занятие</Text>
                    <form action="" className={styles.applicationForm__form}>
                        <Input name="name" placeholder="Имя"></Input>
                        <Select options={options} placeholder="Выберите предпочитаемый вид связи" onChange={handleChange}/>
